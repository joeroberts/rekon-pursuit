...
**Released scope:** Choose a local UTF-8 CSV, preview rows using required `title` and `company` columns, report invalid rows, and import valid opportunities into the encrypted local workspace.
