...
| `BACKUP-PURGE-001` | Multiple retained backups containing deleted/non-deleted data, with confirm, cancellation-before-promotion, per-backup verify failure, interruption/relaunch, retry, and concurrent-backup-attempt variants. | Scope/cutoff blocks or queues mutation; predecessor survives until verified replacement; durable per-backup progress is observable; no false completed result. |
...
| `M1-QA-06` | `DELETE-LOGICAL-001`, `DELETE-QUEUED-WORK-001`, `BACKUP-RETENTION-001`, `BACKUP-PURGE-001`, `EXPORT-UNENCRYPTED-001`, `EXPORT-CANCELLED-001`, `LIFECYCLE-REDACTION-001` | Approved deletion, retention, purge, redaction, and export warning semantics are exact and deterministic. | Implementer / QA verifier + Security/privacy verifier |
